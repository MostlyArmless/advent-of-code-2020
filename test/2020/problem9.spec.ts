...
describe('Problem 9', () => {
    describe('Part 1 - preamble 25', () => {
        ...
        it('Part 1 sample 1', () => {
            expect(problem9_part1(sampleInput + `\n${26}`, preambleLength)).toBeNull;
        });

        it('Part 1 sample 2', () => {
            expect(problem9_part1(sampleInput + `\n${49}`, preambleLength)).toBeNull;
        });

        it('Part 1 sample 3', () => {
            expect(problem9_part1(sampleInput + `\n${100}`, preambleLength)).toEqual(100);
        });

        it('Part 1 sample 4', () => {
            expect(problem9_part1(sampleInput + `\n${50}`, preambleLength)).toEqual(50);
        });

        it('Part 1 final', () => {
            expect(problem9_part1(PROBLEM_9_INPUT, 25)).toEqual(1492208709);
        });
    });
...
576`;
        ...
        it('Sample 1', () => {
            expect(problem9_part1(input, preambleLength)).toEqual(127);
        });
    });
...
309
576`;
            expect(problem9_part2(sampleInput, 5)).toEqual(62);
        });
    });
});